	       ...
	       int pid, pthread_barrier_t* barrier )
{
  ...
  if(grain_size==0)
   ...
   printf("(pid %d: checkpoint 1 pkmedian )",pid);
  ...
  if (points->num <= kmax) {
   ...
   printf("(pid %d: pkmedian checkpoint 2 )",pid);
    shuffle(points);
  ...
  while ((k < kmin)&&(i<SP)) {
   ...
   printf("pid %d: pkmedian checkpoint 3 (after while k<min ) \n",pid);
  ...
  while(1) {
   ...
   printf("pid %d: checkpoint 4 pkmedian (after while(1)) \n",pid);
